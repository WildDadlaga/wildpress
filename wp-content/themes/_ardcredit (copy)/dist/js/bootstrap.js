 ...
 * CHANGES: https://github.com/twbs/bootstrap/pull/12883/files
...
+function ($) {
  ...
  $(document)
    .on('show.bs.modal', '.modal', function (e, scrollbarWidth) {
            $(document.body).css({ 'right': scrollbarWidth + 'px' }).addClass('modal-open').children('.navbar-fixed-top, .navbar-fixed-bottom').css({ 'right': scrollbarWidth + 'px' })
    })
    .on('hidden.bs.modal', '.modal', function () { $(document.body).removeClass('modal-open').css({ 'right': '' }).children('.navbar-fixed-top, .navbar-fixed-bottom').css({ 'right': '' });
                                                     })
